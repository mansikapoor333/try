  ...
  handleChange(checked) {
    ...
    if (checked === true) {
      // console.log("true")
      {
        ...
        // fetch("http://mansihw8-envtoday.eba-jhye5r7y.us-east-1.elasticbeanstalk.com/otherguardian1/politics")
    ...
    else {
      {
        ...
        // fetch("http://mansihw8-envtoday.eba-jhye5r7y.us-east-1.elasticbeanstalk.com/othernewyork1/politics")
