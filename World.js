  ...
  handleChange(checked) {
    ...
    if (checked === true) {
      // console.log("true")
      {
        ...
        // fetch("http://mansihw8-envtoday.eba-jhye5r7y.us-east-1.elasticbeanstalk.com/otherguardian/world")
        fetch("http://localhost:8080/otherguardian/world")
    ...
    else {
      {
        ...
        // fetch("http://mansihw8-envtoday.eba-jhye5r7y.us-east-1.elasticbeanstalk.com/othernewyork/world")
        fetch("http://localhost:8080/othernewyork/world")
          .then(response => response.json())
          .then(data => {
